...
**Nota de precisión (no cambia la pregunta anterior):** los Artículos 24 Bis 2 a 24 Bis 5 del Acuerdo 115/2026 no son categorías independientes entre sí — son una sola unidad interpretativa que dota de contenido operativo a la fracción XVI del Artículo 17, confirmado por análisis legal independiente (*"Los artículos 24 Bis 2 a 24 Bis 5 dotan de contenido operativo a la fracción XVI del artículo 17 de la Ley"*, [grupomultimedialegal.com](https://grupomultimedialegal.com/hacia-un-regimen-antilavado-maduro-las-reformas-de-2026-a-las-reglas-de-caracter-general-de-la-lfpiorpi/)), no solo por el texto legal en sí. Al citar el Artículo 24 Bis 3 o 24 Bis 4 arriba, es en ese sentido — como una elaboración específica de la fracción XVI, no como artículos aislados con alcance propio. Dato adicional, no verificado aquí contra el texto primario del Acuerdo (reportado por un colega revisando un proyecto distinto): el Artículo 24 Bis 6 sería la excepción dentro de ese bloque, anclando a la fracción XV (arrendamiento inmobiliario) en vez de a la XVI — no aplica a Vouch402 de todos modos, dato incluido solo por precisión.

3. **Fecha real de entrada en vigor de la fracción XVI: confirmada — no es el "17 de enero de 2027" que circula en blogs de cumplimiento, ni el "17 de julio de 2025" que una versión anterior de este mismo documento concluyó por error. Es alrededor del 10 de septiembre de 2019.** Esta sección corrige una conclusión propia anterior, no solo una fuente externa. Verificado descargando y extrayendo el texto completo del decreto original (`https://www.diputados.gob.mx/LeyesBiblio/ref/lritf/LRITF_orig_09mar18.pdf`, DOF 9 de marzo de 2018 — el que expidió la Ley Fintech), con extracción de texto real (`pdftotext`), no un resumen automático: su Artículo Décimo, que agregó la fracción XVI al Artículo 17 de la LFPIORPI, la redactó **desde el inicio** sobre activos virtuales — texto literal: *"El ofrecimiento habitual y profesional de intercambio de activos virtuales por parte de sujetos distintos a las Entidades Financieras... facilitando o realizando operaciones de compra o venta de dichos activos propiedad de sus clientes o bien, provean medios para custodiar, almacenar, o transferir activos virtuales..."*, con su propia definición de "activo virtual" incluida ya en 2018. La afirmación anterior de este documento — que la fracción XVI de 2018 tenía "un contenido distinto al de activos virtuales que tiene hoy" — **era incorrecta**, contradicha directamente por el texto oficial.
   - La disposición transitoria de ese mismo decreto de 2018 dice: *"La adición de la fracción XVI del artículo 17 de esta Ley, entrará en vigor a los dieciocho meses siguientes a la entrada en vigor del presente Decreto."* El decreto entró en vigor el 10 de marzo de 2018 (día siguiente a su publicación), así que la fracción XVI —ya en su redacción de activos virtuales— entró en vigor alrededor del **10 de septiembre de 2019**.
   - El decreto de reforma del 16 de julio de 2025 actualizó y amplió esa redacción; no la originó. Comparando ambos textos, el núcleo operativo (compra/venta de activos de clientes; custodia, almacenamiento o transferencia de activos virtuales de terceros) es sustancialmente el mismo desde 2018.
   - **Para efectos prácticos de este documento:** no hay colchón de tiempo. La fracción XVI, en su sustancia de activos virtuales, lleva vigente desde 2019, no desde una fecha futura ni desde 2025. Si la lectura sustantiva del punto 1 de esta sección (que la actividad de Vouch402 queda fuera del alcance de la fracción XVI) resultara equivocada, no hay margen antes de que importe. Ni el "17 de enero de 2027" ni el "17 de julio de 2025" deben usarse como fecha de entrada en vigor de la fracción XVI en comunicación pública de este proyecto.
   - **¿Esta corrección de fecha cambia la respuesta del punto 1?** No en su lógica: el argumento de que Vouch402 solo recibe USDC como pago por su propio servicio, sin intercambiar, custodiar, ni transferir activos de un cliente, es un argumento sobre qué es la actividad, no sobre cuándo empezó a regir la ley — no se debilita por la fecha. Tampoco cambia la ventana real de exposición de Vouch402: el proyecto no operó con pagos reales sino hasta agosto de 2026, muy después incluso de la fecha vieja y equivocada de 2025, así que nunca hubo un período en que Vouch402 operara bajo la creencia de que la ley todavía no aplicaba. Lo que sí cambia es el contexto regulatorio: esta ya no es una regla reciente y sin aplicar — verificado, existe un [criterio general de la UIF sobre la fracción XVI](https://www.gob.mx/uif/prensa/comunicado-040-la-uif-emite-criterio-general-para-la-aplicacion-de-fraccion-xvi-del-articulo-17-de-la-lfpiorpi), y la [página oficial de orientación del SAT](https://wwwmat.sat.gob.mx/consulta/79706/conoce-la-actividad-vulnerable-de-activos-virtuales-) describe a los sujetos obligados como *"personas distintas a entidades financieras que provean plataformas para realizar intercambio de activos virtuales, así como a las facilitadoras de wallets"* — un lenguaje centrado en infraestructura de intercambio/custodia, no en negocios que simplemente reciben un pago en cripto. Esto apoya, con una fuente regulatoria adicional (no solo el texto legal), la lectura del punto 1, aunque no es una aclaración explícita de ese caso específico — sigue siendo un vacío en la guía oficial, no una confirmación. El mecanismo de Aviso para esta fracción opera desde el 2 de abril de 2020, consistente con la fecha de vigencia corregida, con supervisión activa y dual de SAT y UIF desde entonces — siete años de aplicación real, no una regla sin probar.
...
Vouch402 restringe a quién sirve usando una **lista negra, no una lista blanca**: abierto a todos por defecto, cerrado solo donde hay una razón específica y documentada. La alternativa, una lista blanca (cerrado a todos salvo países individualmente pre-aprobados), se evita deliberadamente aquí: no escala, y bloquea a personas reales sin ningún hallazgo real en su contra, solo porque su país nunca se agregó explícitamente a una lista. Cada entrada de abajo existe por una base legal específica y citada, verificada contra una fuente primaria, no copiada de una lista genérica de "países de riesgo".

**Esta es una restricción de naturaleza distinta a la regla del "Buró de Crédito" descrita en otra parte del `DECISION_LOG.md` de este proyecto, y vale la pena decirlo explícitamente para que nunca se confundan.** La regla del Buró de Crédito gobierna qué puede decir y hacer la API de Vouch402 sobre la *dirección que se está calificando*, un tercero, en la transacción de alguien más; existe para mantener a Vouch402 del lado de "los datos", nunca del lado del "veredicto" o del "guardián". Esta sección trata de algo completamente distinto: una decisión ordinaria de negocio y cumplimiento sobre "quién puede ser nuestro cliente", el mismo tipo de decisión que cualquier empresa que ofrece un servicio pagado en línea tiene que tomar respecto a países sancionados. Las dos reglas no están en tensión y ambas siguen plenamente vigentes.

### 5.1 Nivel 1: Prohibido, sin excepción

Vouch402 no sirve a sabiendas solicitudes desde, ni acepta pagos en nombre de, lo siguiente, y lo bloquea en la capa técnica descrita en 5.3:

| Jurisdicción | Base legal | Verificado |
|---|---|---|
| Cuba, Irán, Corea del Norte, Siria | Programas de sanciones integrales de EE. UU. (OFAC): las únicas jurisdicciones actualmente sujetas a un embargo de todo el país (a diferencia de sanciones dirigidas/sectoriales sobre personas, entidades o sectores específicos dentro de un país por lo demás comerciable). Se revisó si los regímenes de sanciones de la UE o de la ONU nombran algún país adicional con embargo integral más amplio que la lista de OFAC; no se encontró ninguno (las sanciones de la UE/ONU agregan muchas más personas y entidades individualmente listadas en muchos más países, una pregunta de cumplimiento distinta y mucho más grande que no se intentó aquí, pero ningún embargo adicional a nivel país). | 2026-08-16 |
| Las regiones de Crimea, Donetsk y Luhansk de Ucrania, ocupadas por Rusia | Misma base de sanciones integrales de OFAC que arriba. **Nótese la limitación técnica real declarada en 5.3**: el resto de la Federación Rusa no está sujeta a un embargo integral (está sujeta en cambio a sanciones sectoriales y específicas por entidad muy extensas, una lista distinta y mucho más grande que este documento no intenta reproducir), y la geolocalización estándar por IP resuelve a Ucrania como un todo, no a estas sub-regiones ocupadas específicas, así que la capa técnica no puede en realidad hacer cumplir este punto en particular. Se declara aquí en vez de omitirse en silencio. | 2026-08-16 |
| China continental | Una base legal separada de los programas de sanciones de arriba, no la misma razón fusionada. El aviso **银发〔2026〕42号** ("Aviso sobre la prevención y disposición adicional de riesgos relacionados con moneda virtual y otros [riesgos]") del Banco Popular de China y otras siete autoridades nacionales, emitido el 6 de febrero de 2026, verificado directamente en el sitio propio del PBoC (`pbc.gov.cn`): declara llanamente que las unidades e individuos del extranjero no pueden, de ninguna forma, proveer ilegalmente servicios relacionados con moneda virtual a entidades del territorio continental ("境外单位和个人不得以任何形式非法向境内主体提供虚拟货币相关服务"), lo cual constituye actividad financiera ilegal, con alcance extraterritorial explícito. **Corrección hecha contra la fuente, no solo repetida**: un borrador anterior de este documento (y la solicitud que lo produjo) citó un aviso de septiembre de 2021 (银发〔2021〕237号) como base; se verificó directamente en el sitio propio del PBoC que este aviso de 2026 **deroga explícitamente** al de 2021 ("同时废止"), así que el aviso de 2026 es la base vigente, no el de 2021. Hong Kong, Macao y Taiwán **no** están cubiertos por este aviso (sistemas legales y financieros separados) y no están restringidos por esta entrada. | 2026-08-16 |

### 5.2 Nivel 2: Restringido, revisión legal pendiente, no es una afirmación de ilegalidad

Lo siguiente **no está bloqueado**, ni técnica ni contractualmente, y nada aquí debe leerse como una declaración de que el servicio de Vouch402 sea ilegal en estos lugares. Significa lo contrario de "despejado": son jurisdicciones con un régimen regulatorio bien documentado y genuinamente costoso de interpretar mal, que aún no se ha revisado contra el patrón específico y real de Vouch402 (aceptar criptomoneda como pago por un servicio de datos, sin custodiar ni intercambiar activos jamás; ver 1.3 y 2.1). Este documento se actualizará, y las fechas de esta tabla se revisarán, una vez que ocurra esa revisión.

| Jurisdicción | Por qué está marcada | Verificado |
|---|---|---|
| Unión Europea / EEE | El Reglamento de Mercados de Criptoactivos (MiCA): su período transitorio para proveedores de servicios de criptoactivos terminó el 1 de julio de 2026, lo que significa que la aplicación plena de licencias ya está vigente en toda la UE. No se ha revisado si la actividad de Vouch402 (aceptar pago en cripto por un servicio de datos no custodio) siquiera encaja en la definición de MiCA de un "servicio de criptoactivos" regulado. | 2026-08-16 |
| Estados Unidos | Se revisó directamente la guía propia de FinCEN de 2019 (FIN-2019-G001, `fincen.gov`): declara que una persona que obtiene moneda virtual convertible y la usa para comprar bienes o servicios no es, solo por eso, un transmisor de dinero, una lectura favorable para un patrón tipo comercio como el de Vouch402. Sin embargo, esa guía es solo federal; los cincuenta estados (más D.C.) tienen cada uno su propio régimen de licencias de transmisión de dinero, a veces con sus propias disposiciones específicas sobre moneda virtual (la BitLicense de Nueva York es la más conocida), y ninguno se ha revisado individualmente. | 2026-08-16 |

### 5.3 Cómo se hace cumplir: dos capas, ninguna basta por sí sola

**Técnica**: `GET /v1/risk-score/:address` y `POST /v1/disputes` (tanto la cotización sin pagar como el reintento pagado) revisan la dirección IP de quien solicita contra una lista de rangos de IP por país de Nivel 1 antes de responder, devolviendo `403` si coincide. `GET /v1/metrics` y `GET /v1/activity` no están restringidos (información pública, agregada, sin pago, sin que se facilite nada para un solicitante específico). Fuente: `src/lib/geoBlock.ts`, datos de rangos de IP de `ipdeny.com`, obtenidos por última vez el 2026-08-16; ver el `geo-data/README.md` propio de ese archivo para la fuente exacta de los datos y su propia limitación declarada (solo a nivel país, no puede resolver el punto de las regiones ucranianas ocupadas de 5.1).

**Contractual**: una autocertificación obligatoria, con dos formas distintas porque este producto tiene dos tipos distintos de quien lo llama, a diferencia de una app web de consumo típica:

- En la propia demo "Pruébalo" de este sitio, hay que marcar una casilla antes de que el botón de Pagar haga algo: *"Certifico que no me encuentro en, ni estoy pagando en nombre de alguien en, Cuba, Irán, Corea del Norte, Siria, las regiones de Ucrania ocupadas por Rusia, o China continental."*
- En el endpoint real `GET /v1/risk-score/:address`, que llaman principalmente agentes autónomos de forma programática, no un humano navegando, no hay casilla que marcar. El equivalente es un campo obligatorio en la prueba de pago: `jurisdictionAttestation: true`. Mismo manejo estricto de booleano que el campo `makePublic` de este proyecto en otra parte: solo el literal `true` cuenta, y su ausencia se rechaza de plano (`403`) en vez de tratarse en silencio como `false`.

**Dicho llanamente, no dado por sentado de otra forma**: el bloqueo geográfico por IP en una API que llaman principalmente agentes autónomos es, por naturaleza, más débil que la misma técnica en un flujo de navegador humano. El navegador de un humano generalmente refleja dónde está esa persona en realidad; un agente autónomo puede correr desde un servidor en la nube en cualquier parte del mundo, sin importar quién lo opera en realidad ni dónde está. El campo de autocertificación existe específicamente porque la capa técnica no puede ser infalible para este tipo de quien llama, no porque se crea que la capa técnica basta por sí sola.

### 5.4 No es la misma pregunta que la ubicación del propio operador

Vouch402 opera desde México. Ese hecho, y si la ley mexicana (específicamente la LFPIORPI y el Acuerdo 115/2026) aplica a la actividad del propio Vouch402, se rastrea por separado en la sección 4 de arriba, y no se resuelve por nada en esta sección. **México no aparece en ningún nivel de esta lista**, deliberadamente: bloquear a usuarios mexicanos no respondería la pregunta de si el propio operador tiene una obligación de cumplimiento, y las dos preguntas (a quién puede servir Vouch402, versus qué obligaciones aplican al propio Vouch402 como operador) se mantienen claramente separadas aquí, en el código, y en el `DECISION_LOG.md`.
