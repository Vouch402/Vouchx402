...
**Precision note (doesn't change the question above):** Articles 24 Bis 2 through 24 Bis 5 of Acuerdo 115/2026 are not independent categories from one another — they are a single interpretive unit that provides operational content for section XVI of Article 17, confirmed by independent legal analysis (*"Articles 24 Bis 2 through 24 Bis 5 give operational content to section XVI of Article 17 of the Law"*, [grupomultimedialegal.com](https://grupomultimedialegal.com/hacia-un-regimen-antilavado-maduro-las-reformas-de-2026-a-las-reglas-de-caracter-general-de-la-lfpiorpi/)), not just from the statutory text alone. Citing Article 24 Bis 3 or 24 Bis 4 above is meant in that sense — as a specific elaboration of section XVI, not as standalone articles with their own independent scope. An additional data point, not verified here against the Acuerdo's primary text (reported by a colleague reviewing a different project): Article 24 Bis 6 would be the exception within that block, anchoring to section XV (real-estate leasing) rather than XVI — doesn't apply to Vouch402 either way, included only for precision.

3. **Section XVI's real effective date: confirmed — not the "January 17, 2027" that circulates in compliance blogs, nor the "July 17, 2025" an earlier version of this same document concluded by mistake. It's around September 10, 2019.** This section corrects an earlier conclusion of this document's own, not just an external source. Verified by downloading and extracting the full text of the original decree (`https://www.diputados.gob.mx/LeyesBiblio/ref/lritf/LRITF_orig_09mar18.pdf`, DOF, March 9, 2018 — the one that issued the Fintech Law), using real text extraction (`pdftotext`), not an automated summary: its Article Ten, which added section XVI to Article 17 of the LFPIORPI, wrote it about virtual assets **from the start** — literal text: *"The habitual and professional offering of virtual-asset exchange by persons other than Financial Entities... facilitating or carrying out purchase or sale operations of said assets belonging to their clients, or providing means to custody, store, or transfer virtual assets..."*, with its own definition of "virtual asset" already included in 2018. This document's earlier claim — that the 2018 version of section XVI had "different content at the time than the virtual-assets content it has today" — **was incorrect**, directly contradicted by the official text.
   - That same 2018 decree's transitory provision states: *"The addition of section XVI of Article 17 of this Law shall take effect eighteen months after this Decree takes effect."* The decree took effect March 10, 2018 (the day after publication), so section XVI — already in its virtual-assets wording — took effect around **September 10, 2019**.
   - The July 16, 2025 reform decree updated and expanded that wording; it did not originate it. Comparing both texts, the operative core (purchase/sale of clients' assets; custody, storage, or transfer of third parties' virtual assets) is substantially the same since 2018.
   - **For this document's practical purposes:** there is no time cushion. Section XVI, in its virtual-assets substance, has been in force since 2019, not from some future date or from 2025. If the substantive reading in item 1 of this section (that Vouch402's activity falls outside section XVI's scope) turned out to be wrong, there is no runway before it matters. Neither "January 17, 2027" nor "July 17, 2025" should be used as section XVI's effective date in this project's public communications.
   - **Does this date correction change the answer to item 1?** Not in its logic: the argument that Vouch402 only receives USDC as payment for its own service, without exchanging, custodying, or transferring a client's assets, is an argument about what the activity *is*, not about when the law took effect — the date doesn't weaken it. It also doesn't change Vouch402's actual exposure window: the project didn't operate with real payments until August 2026, well after even the old, mistaken 2025 date, so there was never a period where Vouch402 operated under the belief that the law didn't apply yet. What does change is the regulatory context: this is no longer a recent, untested rule — verified, there is a [UIF general criterion on section XVI](https://www.gob.mx/uif/prensa/comunicado-040-la-uif-emite-criterio-general-para-la-aplicacion-de-fraccion-xvi-del-articulo-17-de-la-lfpiorpi), and [SAT's own official guidance page](https://wwwmat.sat.gob.mx/consulta/79706/conoce-la-actividad-vulnerable-de-activos-virtuales-) describes obligated subjects as *"persons other than financial entities that provide platforms for carrying out virtual-asset exchange, as well as wallet facilitators"* — language centered on exchange/custody infrastructure, not on businesses that simply receive payment in crypto. This lends some support, from an additional regulatory source (not just the statutory text), to item 1's reading, though it isn't an explicit clarification of that specific case — it remains a gap in the official guidance, not a confirmation. The reporting mechanism for this section has operated since April 2, 2020, consistent with the corrected effective date, with active, dual SAT and UIF supervision since then — seven years of real enforcement, not an untested rule.
